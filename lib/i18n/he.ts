...
export const HE = {
  ...
  waitlist: {
    title: "רשימת המתנה לעדכונים",
    body: "אם תרצו שנעדכן כשיהיה דיוור — השאירו כתובת. זה נשמר במכשיר זה בלבד.",
    email: "כתובת דוא״ל",
    consent:
      "אני מסכים/ה שיצרו קשר לכתובת זו כשיהיה שרת דיוור. כרגע הפרט נשמר במכשיר בלבד ולא נשלח לשום שרת.",
    save: "שמירה במכשיר",
    saved: "נשמר במכשיר זה. לא נשלח אימייל — אין שרת דיוור עדיין.",
    humanTodo: "שליחה אמיתית דורשת שרת. ראו HUMAN_TODO במאגר.",
    invalid: "כתובת דוא״ל לא תקינה, או שלא סומן אישור.",
    already: "שמור במכשיר: {email}",
  },
