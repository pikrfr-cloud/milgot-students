  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 leading-relaxed">
      ...
      <p className="mt-3">
        ...
        (התנדבות, היקף לימודים, ממוצע) — «כמעט זכאים». מועד שהסתיים למחזור שפורסם, כשהשאר מתאים או
      ...
      <p className="mt-3">
        רשומות דיקן / עירייה בלי תנאי סף מאומתים מופיעות בדוח תחת «יש לבדוק במוסד/ברשות» — לא כזכאות
        ולא כ«חסר פרט» בלי שדה למילוי.
      </p>
