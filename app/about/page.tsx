  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 leading-relaxed">
      ...
      <p className="mt-3">
        ...
        פרט לאישור».         כישלון בתנאי זהות (מוסד, קהילה, מגדר, עיר, תחום לימוד, ימי מילואים, עולה, סוג שירות) מופיע תחת «לא
        זכאים». כישלון בתנאים שניתן לשנות (התנדבות, היקף לימודים, ממוצע, מכינה) — «כמעט
        זכאים». מועד שהסתיים למחזור שפורסם, כשהשאר מתאים, מופיע תחת «נסגר למחזור זה — מתאים למחזור הבא» ולא מוסתר.
      </p>
