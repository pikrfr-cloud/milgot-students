...
- Vitest: encoded `תל-אביב-יפו` resolves and the landing has ItemList JSON-LD. `postbuild` scans `out/catalog/city` and fails if any city HTML is the not-found page or Tel Aviv is missing ItemList.
