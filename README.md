...
| אין כישלון, אבל שדה שדולג נדרש; או מלגת ניקוד / דיקן-שלד / בדיקה ברשות | **חסר פרט לאישור** |
| כישלון רק בתנאים שניתן לשנות (התנדבות, היקף, ממוצע, ימי מילואים…) | **כמעט זכאים** |
| כישלון בתנאי זהות (מוסד, קהילה, מגדר, עיר, תחום לימוד, שנת לימוד, מכינה, נתוני קבלה, עולה, סוג שירות) | **לא זכאים** |
